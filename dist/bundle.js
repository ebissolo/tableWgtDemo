...
var _GenericWgt = __webpack_require__(6);
...
// Add Generic widgets
var wgt1 = new _GenericWgt2.default("wgt1", { w: 500, h: 100, x: 0, y: 0, bgcolor: "red", rowOccupied: 0 }, tableWgt);
var wgt2 = new _GenericWgt2.default("wgt2", { w: 500, h: 100, x: 0, y: 0, bgcolor: "green", rowOccupied: 1 }, tableWgt);
...
var _TableGeometry = __webpack_require__(3);

var _TableGeometry2 = _interopRequireDefault(_TableGeometry);

var _RowPrototype = __webpack_require__(4);

var _RowPrototype2 = _interopRequireDefault(_RowPrototype);

var _RowPrototypes = __webpack_require__(5);
...
var TableWgt = function () {
	...
	_createClass(TableWgt, [{
		...
		value: function addScrollbar(scrollbarOptions) {
			this.scrollbar = new _perfectScrollbar2.default(this.elem, scrollbarOptions);

			var self = this;
			this.elem.addEventListener("ps-scroll-y", function (e) {
